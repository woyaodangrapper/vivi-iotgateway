...
{
    /// <summary>
    /// Gravity.SharedKernel.Application.Services.ProblemDetails.ProblemDetails => Problem
    /// </summary>
    /// <param name="problemDetails"><see cref="Gravity.SharedKernel.Application.Services.ProblemDetails"/></param>
    /// <returns><see cref="ObjectResult"/></returns>
    [NonAction]
    protected virtual ObjectResult Problem(Gravity.SharedKernel.Application.Contracts.ResultModels.ProblemDetails problemDetails)
    {
