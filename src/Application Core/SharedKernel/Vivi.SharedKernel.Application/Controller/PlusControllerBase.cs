...
public abstract class PlusControllerBase : ControllerBase
{
    /// <summary>
    /// Vivi.SharedKernel.Application.Services.ProblemDetails.ProblemDetails => Problem
    /// </summary>
    /// <param name="problemDetails"><see cref="Vivi.SharedKernel.Application.Services.ProblemDetails"/></param>
    /// <returns><see cref="ObjectResult"/></returns>
    [NonAction]
    protected virtual ObjectResult Problem(Vivi.SharedKernel.Application.Contracts.ResultModels.ProblemDetails problemDetails)
    {
