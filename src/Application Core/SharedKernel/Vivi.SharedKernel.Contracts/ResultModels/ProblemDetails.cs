namespace Vivi.SharedKernel.Application.Contracts.ResultModels;
...
public sealed class ProblemDetails
{
    ...
    public override string ToString() => JsonSerializer.Serialize(this, SystemTextJson.GetDefaultOptions());
