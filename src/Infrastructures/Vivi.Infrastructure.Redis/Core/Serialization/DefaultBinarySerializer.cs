using Vivi.Infrastructure.Core.Json;
using Vivi.Infrastructure.Redis.Core.Internal;

namespace Vivi.Infrastructure.Redis.Core.Serialization
{
    /// <summary>
    ...
    public class DefaultBinarySerializer : ISerializer
    {
        ...
        /// The json serializer.
        /// </summary>
        private static readonly JsonSerializerOptions jsonSerializerOption = SystemTextJson.GetDefaultOptions();
