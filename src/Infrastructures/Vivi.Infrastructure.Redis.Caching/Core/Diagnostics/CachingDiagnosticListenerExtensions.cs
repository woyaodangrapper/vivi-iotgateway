namespace Vivi.Infrastructure.Redis.Caching.Core.Diagnostics
{
    /// <summary>
    /// Extension methods on the DiagnosticListener class to log Vivi.Infrastructure.Redis
    /// </summary>
    public static class CachingDiagnosticListenerExtensions
    {
        ...
        private const string CachingPrefix = nameof(Vivi.Infrastructure.Redis.Caching);
