namespace Vivi.Infrastructure.Redis.Caching.Core.Interceptor
{
    ...
    /// <summary>
    /// Vivi.Infrastructure.Redis interceptor attribute.
    /// </summary>
    ...
    public class CachingInterceptorAttribute : Attribute
    {
        ...
        /// <summary>
        /// Gets or sets the cache provider name. The default value is Vivi.Infrastructure.RedisInterceptorOptions.CacheProviderName"/>
        /// </summary>
        /// <value>The cache key prefix.</value>
