...
using Vivi.Infrastructure.Redis.Caching.Core;
...
using Vivi.Infrastructure.Redis.Providers.StackExchange;

namespace Vivi.Infrastructure.Redis.Caching.Provider;
...
public partial class DefaultCachingProvider : AbstracCacheProvider, ICacheProvider
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Vivi.Infrastructure.Redis.Redis.DefaultRedisCachingProvider"/> class.
    /// </summary>
    ...
    private RedisKey[] SearchRedisKeys(string pattern)
    {
        ...
        foreach (var server in _servers)
            ...
            // see https://github.com/dotnetcore/Vivi.Infrastructure.Redis/pull/199 for more information
